...
public enum TopicNameEnum {
    ...
    AUDIO_TRANSCRIPTION_COMPLETED_EVENT_TOPIC("AUDIO_TRANSCRIPTION_COMPLETED_EVENT_TOPIC","AUDIO_TRANSCRIPTION_COMPLETED_EVENT_TOPIC","AUDIO_TRANSCRIPTION_COMPLETED_EVENT_TOPIC");
