...
@Slf4j
@Configuration
public class PublishTranscriptionAudiEventHandler extends KafkaBaseTemplate {

    @Autowired
    private TopicConfig topicConfig;

    @Override
    @KafkaListener(id = "audioPublishTranscriptionResultListener",
            topics = PUBLISH_TRANSCRIPTION_RESULT_TOPIC,
    ...
    public void kafkaMessageListener(String message, Acknowledgment ack) {
        ...
        handleMessage(message, topicConfig.getPublishTranscriptResultTopic(), ack);
    }
}
